...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@300&family=Prompt&display=swap" rel="stylesheet">
...
<body>
    ...
    <main class="form-signin text-center">
        <form action="login_db.php" id="loginForm" method="POST">
            ...
            <p class="mt-5 mb-3 text-muted">&copy; Powed By CED9 & 2024</p>
        </form>
    </main>
